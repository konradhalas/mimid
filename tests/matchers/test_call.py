...
def test_match_with_empty_args_kwargs_and_matching_matcher():
    ...
    call_args_matcher = SpecificCallArgumentsMatcher(
        target=func_without_params, arguments=CallArguments(args=(), kwargs={})
    )
...
def test_match_with_args_and_matching_matcher():
    ...
    call_args_matcher = SpecificCallArgumentsMatcher(
        target=func_with_one_param, arguments=CallArguments(args=(eq(1),), kwargs={})
    )
...
def test_match_with_args_and_not_matching_matcher():
    call_args = CallArguments(args=(1,), kwargs={})
    call_args_matcher = SpecificCallArgumentsMatcher(
        target=func_with_one_param, arguments=CallArguments(args=(eq(2),), kwargs={})
    )
...
def test_match_with_kwargs_and_matching_matcher():
    ...
    call_args_matcher = SpecificCallArgumentsMatcher(
        target=func_with_one_param, arguments=CallArguments(args=(), kwargs={"param": eq(1)})
    )
...
def test_match_with_kwargs_and_not_matching_matcher():
    call_args = CallArguments(args=(), kwargs={"param": 1})
    call_args_matcher = SpecificCallArgumentsMatcher(
        target=func_with_one_param, arguments=CallArguments(args=(), kwargs={"param": eq(2)})
    )
